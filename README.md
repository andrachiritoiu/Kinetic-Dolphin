...
| `Project/STL/CMP_L_Shaped_Crank_Handle.stl` | L-shaped crank handle | zi de astea ca un componetele din fusion dar ca stl am unul cu toate
...
> 🎬 **[Watch the motion study and assembly walkthrough on YouTube →](https://youtu.be/-M1nDBFTdhY)**
